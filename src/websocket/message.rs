...
// Text("{\"info\":\"Welcome to the BitFlyer Realtime API.\",\"version\":\"2018-10-23T18:33:47.000Z\",\"timestamp\":\"2018-10-26T05:09:14.006Z\",\"docs\":\"https://www.bitmex.com/app/wsAPI\",\"limit\":{\"remaining\":38}}")
...
impl From<ErrorMessage> for BitFlyerError {
    fn from(e: ErrorMessage) -> BitFlyerError {
        BitFlyerError::WebsocketError {
            status: e.code,
            error: e.message,
        }
    }
